...
<div class="container">
    <h3 class="text-center">编辑站点新闻</h3>
    <div style="text-align: left;margin-top: 10px">
        <form class="form-horizontal" method="post" action="/api/english/siteNews/editNew/{{$new->id}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="bannerUrl0">新闻标题:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="bannerUrl0" name="bannerUrl0"  value="{{$new->bannerUrl}}">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control " id="contents" name="contents" rows="20">{{$new->contents}}</textarea>
                </div>
            </div>
