...
<div class="container">
    ...
    <div style="text-align: left;margin-top: 10px">
        <form class="form-horizontal" method="post" action="/api/english/addNewVideo/" >
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="video_SDURL" name="video_SDURL" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_SDdataSize">标清文件大小:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="video_SDdataSize" name="video_SDdataSize" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_HDURL">高清地址:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="video_HDURL" name="video_HDURL" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_HDdataSize">高清文件大小:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="video_HDdataSize" name="video_HDdataSize" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_FHDURL">超清地址:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="video_FHDURL" name="video_FHDURL" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_FHDdataSize">超清文件大小:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="video_FHDdataSize" name="video_FHDdataSize" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_introduce">视频介绍:</label>
                <div class="col-sm-10">
                    <textarea class="form-control " id="video_introduce" name="video_introduce" rows="5"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_dialog_bg">对话背景:</label>
                <div class="col-sm-10">
                    <textarea class="form-control " id="video_dialog_bg" name="video_dialog_bg" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_dialog_english">原文:</label>
                <div class="col-sm-10">
                    <textarea class="form-control " id="video_dialog_english" name="video_dialog_english" rows="10"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_dialog_chinese">翻译:</label>
                <div class="col-sm-10">
                    <textarea class="form-control " id="video_dialog_chinese" name="video_dialog_chinese" rows="5"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="video_goldenSentence">影视金句:</label>
                <div class="col-sm-10">
                    <textarea class="form-control " id="video_goldenSentence" name="video_goldenSentence" rows="5"></textarea>
                </div>
            </div>
