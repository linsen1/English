...
<div class="container">
    <h3 className="text-center">常见字母组合列表</h3>
    <ol class="breadcrumb">
        <li><a href="/english/symbol/symbolList">返回音标列表</a></li>
        <li><a href="/english/symbol/addWordsgroup/{{$id}}">添加字母组合</a></li>
    </ol>
    <table class="table table-bordered" style="margin-top: 20px">
        ...
        @foreach ($symbolWordsgroup as $symbol)
            <tr>
                <td>{{$symbol->id}}</td>
                <td>{{$symbol->wordGroup}}</td>
                <td>
                    &nbsp;<a href="/english/symbol/editWordsGroup/{{$symbol->id}}/PID/{{$id}}">编辑</a>&nbsp;&nbsp;
                </td>
                <td>
