...
<div class="container">
    ...
    <div style="text-align: left;margin-top: 10px">
        <form class="form-horizontal" method="post" action="/api/english/addNewSentence/refID/{{$refID}}/type/{{$type}}" >
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="EnWords">英文:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="EnWords" name="EnWords" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="CnWords">中文:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="CnWords" name="CnWords" >
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="EnMp3">语音MP3:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="EnMp3" name="EnMp3" >
                </div>
            </div>
