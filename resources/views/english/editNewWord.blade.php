    ...
    <body>
            ...
            <div class="container">
                ...
                <div style="text-align: left;margin-top: 10px">
                  <form class="form-horizontal" method="post" action="/api/english/editNewWord/{{$id}}/mottoID/{{$mottoID}}/type/{{$no}}" >
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" class="form-control " id="yinbiaoMp3" name="yinbiaoMp3" value="{{$word->yinbiaoMp3}}">
                          </div>
                      </div>
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right" for="yinbiao1">美式音标:</label>
                          <div class="col-sm-10">
                              <input type="text" class="form-control " id="yinbiao1" name="yinbiao1" value="{{$word->yinbiao1}}">
                          </div>
                      </div>
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right" for="yinbiao1Mp3">美式MP3:</label>
                          <div class="col-sm-10">
                              <input type="text" class="form-control " id="yinbiao1Mp3" name="yinbiao1Mp3" value="{{$word->yinbiao1Mp3}}">
                          </div>
                      </div>
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right" for="chinese">中文:</label>
                          <div class="col-sm-10">
                              <textarea class="form-control " id="chinese" name="chinese" rows="5">{{$word->chinese}}</textarea>
                          </div>
                      </div>
