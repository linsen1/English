...
<head>
    ...
    <title>添加常见字母组合</title>
    <link href="/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>

<div class="container">
    <h3 class="text-center">添加常见字母组合</h3>
    <div style="text-align: left;margin-top: 10px">
        <form class="form-horizontal" method="post" action="/api/english/symbol/addWordsGroup/{{$id}}" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label text-right" for="wordGroup">字母组合:</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control " id="wordGroup" name="wordGroup" >
                </div>
            </div>
            <div class="form-group">
